    ...
    >
      ...
      >
        ...
        {product.image ? (
          ...
          <div className="w-full h-56 bg-[#2B2FB8] flex flex-col items-center justify-center gap-3">
        ...
        <div className="p-6">
          ...
          <div className="bg-[#F5F6FF] rounded-2xl p-4 mb-5 grid grid-cols-2 gap-3">
            ...
            <div>
              <p className="text-xs text-gray-400 font-medium uppercase tracking-wide">Personalización</p>
              <p className="text-sm font-semibold text-gray-800 mt-0.5">100% a medida</p>
            </div>
            <div>
              <p className="text-xs text-gray-400 font-medium uppercase tracking-wide">Técnica</p>
              <p className="text-sm font-semibold text-gray-800 mt-0.5">Bordado / Sublimación / DTF</p>
            </div>
            <div>
              <p className="text-xs text-gray-400 font-medium uppercase tracking-wide">Origen</p>
              <p className="text-sm font-semibold text-gray-800 mt-0.5">🇪🇨 Hecho en Ecuador</p>
            </div>
          </div>
